    ...
    public static void main(String[] args) {
        {
            try (Scanner in = new Scanner(System.in)) {
             ...
             //   Object K = TwoFish.TwoFish.Twofish_Algorithm.makeKey(key);
               // byte[] ct = TwoFish.TwoFish.Twofish_Algorithm.blockEncrypt(plainText, 0, K);
              //  String cipherText = new String(ct);
               ...
               // Object K2 = TwoFish.TwoFish.Twofish_Algorithm.makeKey(key2);
               // byte[] cpt = TwoFish.TwoFish.Twofish_Algorithm.blockDecrypt(ct, 0, K2);
